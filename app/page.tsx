...
const CONFIGURACION_TEATRO = {
  secciones: {
    izquierda: {
      ...
      filas: [
        { fila: 1, butacas: [103, 104, 105, 106, 107, 108] },
        { fila: 2, butacas: [202, 203, 204, 205, 206, 207, 208] },
        { fila: 3, butacas: [301, 302, 303, 304, 305, 306, 307, 308] },
        { fila: 4, butacas: [400, 401, 402, 403, 404, 405, 406, 407, 408] },
        { fila: 5, butacas: [500, 501, 502, 503, 504, 505, 506, 507, 508] },
        { fila: 6, butacas: [600, 601, 602, 603, 604, 605, 606, 607, 608] },
        { fila: 7, butacas: [700, 701, 702, 703, 704, 705, 706, 707, 708] },
        { fila: 8, butacas: [800, 801, 802, 803, 804, 805, 806, 807, 808] },
        { fila: 9, butacas: [900, 901, 902, 903, 904, 905, 906, 907, 908] },
        { fila: 10, butacas: [1000, 1001, 1002, 1003, 1004, 1005, 1006, 1007, 1008] },
      ],
    },
    "centro-izq": {
